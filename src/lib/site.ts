...
export const TRAINING_SPLIT = [
  {
    ...
    day: "mon",
    exercises: [
      { name: "incline dumbbell press", sets: "2 x 6-10" },
      { name: "lat pulldown", sets: "2 x 8-12" },
      { name: "iso-lateral bench machine", sets: "2 x 8-12" },
      { name: "seated cable row (close grip)", sets: "2 x 8-12" },
      { name: "cable lateral raise", sets: "2 x 12-failure" },
      { name: "rear delt fly", sets: "2 x 12-16" },
      { name: "ez-bar preacher curl", sets: "2 x 8-12" },
      { name: "tricep pushdown", sets: "2 x 10-15" },
    ],
  },
  {
    name: "lower a",
    ...
    exercises: [
      ...
      { name: "leg extension", sets: "2 x 12-failure" },
      { name: "hip thrust", sets: "2 x 8-12" },
      { name: "standing calf raise", sets: "2 x 12-failure" },
      { name: "cable crunch", sets: "2 x 10-15" },
    ],
  },
  {
    name: "rest",
  ...
  },
  {
    ...
    exercises: [
      ...
      { name: "neutral-grip pulldown", sets: "2 x 6-10" },
      { name: "machine shoulder press (hammer strength)", sets: "2 x 6-10" },
      { name: "chest-supported machine row", sets: "2 x 8-12" },
      { name: "cable lateral raise", sets: "2 x 12-failure" },
      { name: "rear delt fly", sets: "1 x 12-16" },
      { name: "incline dumbbell curl", sets: "2 x 8-12" },
      { name: "overhead tricep extension", sets: "2 x 10-15" },
    ],
  },
  {
    name: "lower b",
    ...
    exercises: [
      ...
      { name: "back extension", sets: "2 x 10-15" },
      { name: "standing calf raise", sets: "2 x 12-failure" },
