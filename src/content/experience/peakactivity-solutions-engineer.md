...
bullets:
  ...
  - "Developed a daily analytics anomaly-reporting prototype on **SteelEngine**, replacing short-term baseline analysis with year-over-year metric comparisons, data-quality safeguards, and evidence-backed reporting paths for anomalies, normal results, and human review."
  - "Deployed a Gmail-to-Slack demo-request automation handling signature cleanup, verified contact extraction, attachment uploads, duplicate protection, and failure paths, confirmed by **3** consecutive successful live executions."
  - "Developed a QA-automation proof of concept that turned Jira tickets into versioned **Playwright** test cases and regression batches, building **2** workflows and **3** run-history tables, with the API-to-browser-to-report flow validated by **9/9** automated tests."
